        ...
        <div className="main-about">
          ...
          <div className="about-container">
            <div className="about">
              ...
              <p className="img-title">Read Books</p>
              <p>
                Get yourself a book and live yourlife as book lover. we land you
                hand that will provide you books that you want to read at a
                minimal amount.Boost you passion as book lover.
              </p>
            </div>
            <div className="about">
